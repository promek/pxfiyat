...
//@ 17,02 Say "ALT+S            : Ekran koruyucuyu Çalıştırma"
...
SetColor("15/5,15/1,,,15/5")
@ 01,00 Say _TR("--------------------------------------------------------------------------------")
@ 02,00 Say _TR("| Tarih   Hesap Kodu Açıklama                          Giriş         Çıkış     |")
@ 03,00 Say _TR("--------------------------------------------------------------------------------")
For nI:=4 To 18
    @ nI,00 Say _TR("|        |          |                            |              |              |")
Next
@ 19,00 Say _TR("--------------------------------------------------------------------------------")
@ 20,00 Say _TR("|                                          Toplam:                             |")
@ 21,00 Say _TR("|                              Dünkü Kasa Mevcudu:                             |")
@ 22,00 Say _TR("|                                    Genel Toplam:                             |")
@ 23,00 Say _TR("--------------------------------------------------------------------------------")
Return
//////////////////////////////////////////////////////////////////////////////
